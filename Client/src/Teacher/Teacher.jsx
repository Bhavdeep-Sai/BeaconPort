...
const subNavArr = [
  ...
  { link: "/teacher/attendance",  label: "Attendance",   Icon: BarChart2 },
  { link: "/teacher/examination", label: "Examinations", Icon: ClipboardList },
  { link: "/teacher/notice",      label: "Notices",      Icon: Bell },
  { link: "/teacher/payments",    label: "Payments",     Icon: Wallet },
];
  ...
  return (
    <button
      ...
      className={[
        ...
        active
          ? "border-l-blue-500 bg-blue-500/15 text-blue-400"
          : "border-l-transparent text-gray-400 hover:bg-blue-500/10 hover:text-blue-300",
      ].join(" ")}
    >
      ...
      <div className={["flex items-center h-16 border-b border-gray-700/60 px-4 shrink-0", expanded ? "justify-between" : "justify-center"].join(" ")}>
        {expanded && (
          <span className="text-lg font-bold text-gray-100 tracking-tight select-none">
            Beacon<span className="text-blue-500">Port</span>
          </span>
        )}
        {!forceFull && (

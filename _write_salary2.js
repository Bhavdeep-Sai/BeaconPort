...
const targetPath = path.resolve('w:/Projects/BeaconPort/Client/src/School/components/Salary/Salary.jsx');
fs.writeFileSync(targetPath, content, 'utf8');
console.log('Written', fs.statSync(targetPath).size, 'bytes');
